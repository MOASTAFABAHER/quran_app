class jDate {
  ...
  jDate({this.code, this.status, this.data});

  jDate.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Month {
  ...
  Month({this.number, this.en, this.arr});
...
class nWeekday {
  ...
  nWeekday.fromJson(Map<String, dynamic> json) {
    en = json['en'];
  }
...
class nMonth {
  ...
  nMonth({this.number, this.en});

  nMonth.fromJson(Map<String, dynamic> json) {
    number = json['number'];
    en = json['en'];
  }
