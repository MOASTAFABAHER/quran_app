...
import 'package:quran_app/component/item_commpont.dart';
import 'package:quran_app/models/counter_models.dart';
import 'package:quran_app/component/counter_time.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<GetDateCubit, GetDateState>(
      listener: (context, state) {},
      builder: (context, state) {
        var cubit = GetDateCubit.get(context);
                        ...
                        child: Stack(
                          children: <Widget>[
                            Container(
                              ...
                              image: DecorationImage(image:AssetImage( 'assets/image/HomeImage.jpeg'),fit: BoxFit.cover  ),
                                  ...
                                  Container(
                                    ...
                                    child: IntrinsicHeight(
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            cubit.jGetDate.data!.date!.hijri!.month!.arr ?? '',
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 20.sp),
                                          ),
                       ...
                       margin: EdgeInsets.symmetric(vertical: 18.r),
                        ...
                        child: Column(
                          children: [
                            ItemCommponent(
                                label: 'الفجر',
                                labelTime: cubit.jGetDate.data!.timings!.fajr),
                            ItemCommponent(
                                label: 'الشروق',
                                labelTime:
                            ...
                            ItemCommponent(
                                label: 'الظهر',
                                labelTime: cubit.jGetDate.data!.timings!.dhuhr),
                            ItemCommponent(
                                label: 'العصر',
                            ...
                            ItemCommponent(
                                label: 'العشاء',
                                labelTime: cubit.jGetDate.data!.timings!.isha),
                          ],
                        ),
                      ),
                    ),
